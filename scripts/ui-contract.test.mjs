...
import { verifiedPriceRecord } from "../public/filter-data.js";
import { spreadMarkerPoints } from "../public/map-view.js";
...
test("pending prices cannot reach apartment details", () => {
  ...
  assert.equal(verifiedPriceRecord({ complexes: { "1": record } }, "1", "11200"), null);
});
