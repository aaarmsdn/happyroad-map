...
export { apartmentColor, priceColor, priceFor, priceMetric, pricePerPyeong, pricePerPyeongFor, priceRecordForDisplay, transactionPrice, transactionPricePerPyeong } from "./price-data.js?v=1";
