...
export { apartmentColor, priceColor, priceFor, priceMetric, pricePerPyeong, pricePerPyeongFor, priceRecordForDisplay, representativeAreaPrice, transactionPrice, transactionPricePerPyeong } from "./price-data.js?v=7";
